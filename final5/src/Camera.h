...
class PerspectiveCamera : public Camera
{
  public:
        ...
        _angle(angle)
    {
		...
		_up=_horizontal.cross(_horizontal,_direction); //deal with nonorthormal camera, recommended on piazza 
    }
	...
	direction.normalize(); //ray from camera is always normalized, direction is different than _direction careful lol
